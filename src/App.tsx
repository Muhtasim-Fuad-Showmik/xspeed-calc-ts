        ...
        <div className="result-panel">
          <div className="result-card">
            <div className="d-flex align-items-center">
              <span className="math-result">= 24</span>
              <span className="calculation-title">Calculation Title</span>
              <button className="red-btn">See Input</button>
            </div>
          </div>

          <div className="result-card">
            <div className="d-flex align-items-center">
              <span className="math-result">= 24.232</span>
              <span className="calculation-title">Calculation Title</span>
              <button className="red-btn">See Input</button>
            </div>
          </div>
